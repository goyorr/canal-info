          ...
          <div className="px-6 py-8 md:px-10">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">+212 522-665501</p>
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">+212 522-665502</p>
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">+212 661-194540</p>
              </div>
              <div>
                <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300">Email</h3>
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">canalinformatique@menara</p>
              </div>
            </div>
          </div>
        </div>
